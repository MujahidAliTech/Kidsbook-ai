  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-md border border-slate-200 dark:border-slate-800">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-amber-100 dark:bg-amber-950/80 text-amber-900 dark:text-amber-300 text-xs font-black rounded-full border border-amber-200 dark:border-amber-800 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {FEATURED_TEMPLATES.map((tpl) => (
          <div
            ...
            className="bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border-slate-200/80 dark:border-slate-800 hover:border-indigo-500 dark:hover:border-indigo-500 shadow-sm hover:shadow-xl transition-all cursor-pointer flex flex-col justify-between group"
          >
            <div>
              {/* Header Badges */}
              ...
              {/* Cover Emoji Badge */}
              <div className="w-20 h-20 rounded-2xl bg-slate-50 dark:bg-slate-800 border-2 border-dashed border-slate-200 dark:border-slate-700 flex items-center justify-center text-4xl mb-4 group-hover:scale-105 transition-transform">
                {tpl.coverEmoji}
              </div>
